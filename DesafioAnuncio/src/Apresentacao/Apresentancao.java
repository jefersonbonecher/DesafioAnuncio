...
public class Apresentancao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cadastro de Anuncio");

        jLabel2.setText("Nome do Anúncio:");

        jLabel3.setText("Cliente:");

        jLabel4.setText("Data Ínicio:");

        jLabel5.setText("Data Fim:");

        jLabel6.setText("Valor Diario:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Apresentancao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Apresentancao().setVisible(true);
            }
        });
    }
